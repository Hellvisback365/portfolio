...
const timelineMilestones = [
  {
    ...
    description: 'Partecipante alla challenge aziendale: sviluppo in team di un assistente AI per consulenza enterprise.',
    highlights: [
  ...
  },
  {
    ...
    description: 'Informatica e Tecnologia per la Produzione del Software, con focus su AI, sistemi e sviluppo software.',
    highlights: [
  ...
  },
  {
    ...
    location: 'Bari',
    description: 'Esperienza lavorativa che ha sviluppato resilienza, capacità di problem-solving e lavoro in team.',
    highlights: [
